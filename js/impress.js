...
(function ( document, window ) {
    ...
    var impress = window.impress = function ( rootId ) {
        ...
        var background_position = jQuery("body").css("background-position");
        ...
        var goto = function ( el, duration ) {
            ...
            (function(el,$){
                ...
                if($(el).attr("data-background-position") != undefined){
                    $("body").css("background-position",$(el).attr("data-background-position"));
                    if($(el).attr("data-change-all") == "true"){
                        background_position = $(el).attr("data-background-position");
                    }
                }else{
                    $("body").css("background-position",background_position);
                }
